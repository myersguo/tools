...
.terminal pre{max-width:100%;min-width:0;overflow-x:hidden;white-space:pre-wrap;overflow-wrap:anywhere;font-size:clamp(13px,1.25vw,15px);line-height:1.86}.terminal code{display:block;min-width:0}.step-command pre{max-width:100%;min-width:0;overflow-x:auto;white-space:pre}.step-command code{display:block;min-width:max-content}.term-strong{color:var(--terminal-hot);font-weight:850}
...
@media(max-width:820px){.hero-grid{grid-template-columns:1fr}.card-grid{grid-template-columns:1fr}}
